...
<html>
  <head>
    ...
    <title>Daale - Registro Instructor</title>
    ...
    <section>
      <div class="logo">
        ...
        <form class="animated fadeInUp" action="" id="formulario" method="post">
		       		<h2 class="">Regístrate como Instructor</h2>
              <div class="line"></div>
              ...
              <input type="number" name="telefono" placeholder="Teléfono" maxlength="10" style="width:39%; float:left;" required>
         ...
         <script type="text/javascript">
           jQuery(document).on('submit', '#formulario', function(event){
             ...
             jQuery.ajax({
               url: '../../php/instructor/registrar.php',
               type: 'POST',
               dataType: 'json',
               data: $(this).serialize(),
               beforeSend: function(){
