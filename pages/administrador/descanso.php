			...
			<table class="tabla">
			  <tr>
				...
				<?php
					...
					$query = "SELECT *, G.Nombre AS NG FROM descanso D INNER JOIN general G INNER JOIN user U  WHERE D.ID_General=G.ID_General AND G.User=U.ID_User";
					$resultado = $conexion->query($query);
					while($row = $resultado->fetch_assoc()){
				 ?>
			  <tr>
					<td><?php echo $row['ID_Descanso'] ?></td>
					<td><?php echo $row['Hrs_Dormidas'] ?></td>
