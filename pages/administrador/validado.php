...
<head>
	...
	<title>Daale - Instructor validado</title>
...
<body>
	...
	<?php
	if ($_SESSION['ValidadoI']==0) {
	}else if($_SESSION['ValidadoI']==1){
		echo "<script>";
		...
		echo "</script>";
		$_SESSION['ValidadoI']=0;
	}else if($_SESSION['ValidadoI']==3){
		echo "<script>";
	...
	include("../../php/config.php");
	 ?>
	<header>
		<?php include('../../partes/header-validar.php'); ?>
	</header>
  <section>
		<div class="caja animated fadeInUp" style="margin-top:150px;">
			<h2 >Instructor validado</h2>
			<a id="boton-derecha" href="validar.php"><span class="fa fa-check"></span>&nbsp&nbspValidar</a>
			<div class="line"></div>
			...
			<table class="tabla">
			  <tr>
				...
				<?php
					...
					$query = "SELECT * FROM instructor WHERE Validado=1";
			  ...
			  <tr>
			    ...
			    <td class="cambiar"> <a href="../../php/administrador/validado.php?id=<?php echo $row['ID_Instructor']; ?>"><span class="fa fa-times"></span></a></td>
			  </tr>
				<?php } ?>
			</table>
		</div>
