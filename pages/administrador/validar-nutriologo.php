...
<head>
	...
	<title>Daale - Validar Nutriólogo</title>
...
<body>
	...
	<?php
	if ($_SESSION['ValidarN']==0) {
	}else if($_SESSION['ValidarN']==1){
		echo "<script>";
  ...
  <section>
		<div class="caja animated fadeInUp" style="margin-top:150px;">
			<h2 >Validar Nutriólogo</h2>
			<a id="boton-derecha" href="validado-nutriologo.php"><span class="fa fa-eye"></span>&nbsp&nbspValidados</a>
			<div class="line"></div>
			...
			<table class="tabla">
			  <tr>
				...
				<?php
					...
					$query = "SELECT * FROM nutriologo WHERE Validado=0";
			  ...
			  <tr>
			    ...
			    <td class="cambiar"> <a href="../../php/administrador/validar-nutriologo.php?id=<?php echo $row['ID_Nutriologo']; ?>"><span class="fa fa-check"></span></a></td>
			  </tr>
				<?php } ?>
			</table>
		</div>
