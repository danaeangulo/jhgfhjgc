			...
			<table class="tabla">
			  <tr>
				...
				<?php
					...
					$query = "SELECT *, I.Nombre AS NI, E.Nombre AS NE FROM alimentos E INNER JOIN nutriologo I INNER JOIN user U WHERE E.ID_Nutriologo=I.ID_Nutriologo AND I.User=U.ID_User";
			  ...
			  <tr>
					...
					<td><?php echo $row['ID_Alimentos'] ?></td>
					<td><?php echo $row['NE'] ?></td>
					<td><?php echo $row['Cantidad'];?>&nbsp
						<?php
