...
<head>
	...
	<title>Daale - Editar Pregunta</title>
...
<body>
	...
	<?php
		...
		$id=$_REQUEST['id'];
		$query = "SELECT * FROM preguntas WHERE ID_Preguntas='$id'";
  ...
  <section>
		...
		<form action="" id="formulario" method="post">
				...
				<input  type="text" name="nombre" value="<?php echo $row['Pregunta']; ?>" required>
		...
		<script type="text/javascript">
			jQuery(document).on('submit', '#formulario', function(event){
				...
				jQuery.ajax({
					url: '../../php/administrador/editar-pregunta.php?id=<?php echo $id; ?>',
					type: 'POST',
					dataType: 'json',
					data: $(this).serialize(),
					beforeSend: function(){
