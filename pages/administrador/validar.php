...
<head>
	...
	<title>Daale - Validar Instructor</title>
...
<body>
	...
	<?php
	if ($_SESSION['ValidarI']==0) {
	}else if($_SESSION['ValidarI']==1){
		echo "<script>";
  ...
  <section>
		<div class="caja animated fadeInUp" style="margin-top:150px;">
			<h2 >Validar Instructor</h2>
			<a id="boton-derecha" href="validado.php"><span class="fa fa-eye"></span>&nbsp&nbspValidados</a>
			<div class="line"></div>
			...
			<table class="tabla">
			  <tr>
				...
				<?php
					...
					$query = "SELECT * FROM instructor WHERE Validado=0";
			  ...
			  <tr>
			    ...
			    <td class="cambiar"> <a href="../../php/administrador/validar.php?id=<?php echo $row['ID_Instructor']; ?>"><span class="fa fa-check"></span></a></td>
			  </tr>
				<?php } ?>
			</table>
		</div>
