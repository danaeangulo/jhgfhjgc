...
<body>
	...
	<div class="modal" id="nombre">
		<div class="modal-contenido">
			...
			<form action="../../php/nutriologo/cambiar-nombre.php" method="post">
	...
	<div class="modal" id="fecha">
		<div class="modal-contenido">
			...
			<form action="../../php/nutriologo/cambiar-fecha.php" method="post">
	...
	<div class="modal" id="correo">
		<div class="modal-contenido">
			...
			<form action="../../php/nutriologo/cambiar-correo.php" method="post">
	...
	<div class="modal" id="nombre-usuario">
		<div class="modal-contenido">
			...
			<form action="../../php/nutriologo/cambiar-username.php" method="post">
	...
	<div class="modal" id="clave">
		<div class="modal-contenido">
			...
			<form action="../../php/nutriologo/cambiar-clave.php" method="post">
	...
	<div class="modal" id="telefono">
		<div class="modal-contenido">
			...
			<form action="../../php/nutriologo/cambiar-telefono.php" method="post">
