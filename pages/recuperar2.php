      ...
      <img src="../images/Daale_Blanco.png" alt="">
          ...
          <section>
            <div class="formulario">
              ...
              <div id="cuadro" style="margin-bottom:110px;">
                <h3 style="width:49%; float:left; margin-right:2%;">Elige una de tus preguntas</h3>
                <h3 style="width:49%; float:left;">Respuesta</h3>
                <form action="" id="form-preg" method="post">


                  <select name="pregunta" style="width:49%; float:left; height:40px; margin-right:2%; font-size:15px;">
                    <?php
                    session_start();
                    $id=$_SESSION['usuario'];
                    ...
                    ?>
                    <option value="<?php echo $row2['Pregunta1']; ?>" require><?php echo $row2['Pregunta']; ?></option>
                    <?php
                    ...
                    ?>
                    <option value="<?php echo $row3['Pregunta2']; ?>" require><?php echo $row3['Pregunta']; ?></option>

                  </select>
                  <input type="text" name="respuesta" placeholder="" style="width:49%; float:left; height:40px;" required>
                  <input type="submit" style="margin-left:10px;" value="Siguiente" id="mas2" class="btn2">


                </form>
                <input type="button" value="Regresar" id="menos1" onclick="anterior('cuadro', 'mas1', 'sig')">
                <script type="text/javascript">
          				jQuery(document).on('submit', '#form-preg', function(event){
          					event.preventDefault();
          					jQuery.ajax({
          						url: '../php/validar-pregunta2.php',
          						type: 'POST',
          						dataType: 'json',
          						data: $(this).serialize(),
          						beforeSend: function(){
