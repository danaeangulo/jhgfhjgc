  ...
  <body>
    <section>
      <div class="logo animated flipInX">
        ...
        <form class="formulario animated swing" action="../../php/general/foto-perfil.php" method="post" enctype="multipart/form-data">
              ...
              <div class="abajo-botones">
                ...
                <div id="close" class="cancelar" style="float:right; width:29%; margin-right:2%;">
                  <a  href="peso.php">Omitir</a>
                </div>
              </div>
