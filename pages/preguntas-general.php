  ...
  <body>
    ...
    <div class="logo">
      ...
      <img src="../images/Daale_Blanco.png" alt="">
          ...
          <section>
            <div class="formulario" style="padding-bottom:115px;">
                <form action="" id="preg" method="post">
                  ...
                  <div class="line"></div>
                    ...
                    <select name="pregunta" class="pregunta-respuesta">
                      <?php
                        session_start();
                        $id=$_SESSION['usuario'];
                    ...
                    <input type="text" name="respuesta" placeholder="" class="respuesta" required>
                ...
                <script type="text/javascript">
          				jQuery(document).on('submit', '#preg', function(event){
          					event.preventDefault();
          					jQuery.ajax({
          						url: '../php/validar-pregunta-general.php',
          						type: 'POST',
          						dataType: 'json',
          						data: $(this).serialize(),
          						beforeSend: function(){
